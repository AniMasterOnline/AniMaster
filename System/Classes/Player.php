    ...
    class Player{
        ...
        public function add(){
            ...
            $db->query("INSERT INTO Player(vida,ataque,defensa,turno,poderes,id_equipo) "
                    . "VALUES ('$this->vida', '$this->ataque', '$this->defensa', '$this->turno', '$this->poderes', '$this->id_equipo')");
            $db->close();
        }
        public function mod(){
            $db = new connexio();
            $db->query("UPDATE Player SET vida='$this->vida',ataque='$this->ataque',defensa='$this->defensa',turno='$this->turno',poderes='$this->poderes',id_equipo='$this->id_equipo' WHERE id_player= '$this->id_player'");
            $db->close();
        }
        ...
        public function view_all(){
            ...
            while($obj = $query->fetch_assoc()){
                $Player = new Player($obj["id_player"],$obj["id_equipo"],$obj["vida"],$obj["ataque"], $obj["defensa"], $obj["turno"], $obj["poderes"]);
                //var_dump($Usuari);
